...
var MSAL = /** @class */ (function () {
    ...
    MSAL.prototype.getAccount = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 9]);
                        if (!(this.data.user && Object.keys(this.data.user).length > 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.lib.acquireTokenSilent(__assign(__assign({}, request), { account: this.data.user }))];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.lib.acquireTokenSilent(request)];
                    case 3:
                        _a = _b.sent();
                        _b.label = 4;
                    case 4:
                    ...
                    case 5:
                        error_1 = _b.sent();
                        if (!this.requiresInteraction(error_1.errorCode)) return [3 /*break*/, 6];
